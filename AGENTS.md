...
- **Repo meta:** `.github/workflows/ci.yml` + `release.yml`, `README.md`, `ROADMAP.md`, `PM_PLAN.md`
...
| 08-20 | TTS: `TTSManager` (Piper/Coqui stub, `tts/` dir), `ROADMAP.md` updated | `Managers/TTSManager.swift` |
...
| 08-20 | PM spec + CTO plan: `PM_SPEC_FIXES.md`, `CTO_PLAN.md` (no pbxproj change per spec, now patched to include new views) | `PM_SPEC_FIXES.md`, `CTO_PLAN.md` |
...
- Git: `main`, `ci.yml`/`release.yml` on `macos-14` + Xcode 16.3, `ROADMAP.md` is source of truth, `PM_PLAN.md` for sprints.

## Roadmap (pointer)

See [`ROADMAP.md`](/Users/gauravtewari/Desktop/Desktop/wisperVoice/ROADMAP.md) and [`PM_PLAN.md`](/Users/gauravtewari/Desktop/Desktop/wisperVoice/PM_PLAN.md). Next: streaming Whisper via WhisperKit, hold-to-talk, custom vocab, per-app formatting, notarized DMG + Sparkle.

## For the next agent

1. Read this + `ROADMAP.md` + `PM_PLAN.md` first.
